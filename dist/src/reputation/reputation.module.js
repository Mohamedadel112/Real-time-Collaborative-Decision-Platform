...
exports.ReputationModule = ReputationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [reputation_service_1.ReputationService, promotion_service_1.PromotionService],
        exports: [reputation_service_1.ReputationService, promotion_service_1.PromotionService],
    })
], ReputationModule);
